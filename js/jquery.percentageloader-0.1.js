...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        ...
        lingrad.addColorStop(0, 'rgba(51, 51, 51, 0.6)');
        lingrad.addColorStop(1, 'rgba(68, 68, 68,.5)');

        /* Create inner gradient for the outer ring */
        innerGrad = ctx.createLinearGradient(cX, cX * 0.133333, cX, canvas.height - cX * 0.133333);
        innerGrad.addColorStop(0, 'rgba(51, 51, 51, 0.8)');
        innerGrad.addColorStop(1, 'rgba(51, 51, 51, 0.8)');

        /* Tube gradient (background, not the spiral gradient) */
        tubeGrad = ctx.createLinearGradient(cX, 0, cX, canvas.height);
        tubeGrad.addColorStop(0, 'rgb(124, 187, 237)');
        tubeGrad.addColorStop(1, 'rgb(124, 187, 237)');
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            ctx.beginPath();
            ctx.strokeStyle = 'rgba(68, 68, 68,.5';
            ...
            (function () {
                ...
                percentageText.style.color = 'rgb(7, 196, 7)';
                percentageText.style.font = fontSize.toString() + 'px hack-regular';
                percentageText.style.textShadow = '0 0px 0px #FFFFFF';
                ...
                smallSize = cX / 5.5;
                valueText.style.color = '#47c347';
                valueText.style.font = smallSize.toString() + 'px hack-regular';
